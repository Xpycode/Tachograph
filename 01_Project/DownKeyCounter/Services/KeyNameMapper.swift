...
enum KeyNameMapper {
    static func label(forKeyCode keyCode: UInt16, modifiers: CGEventFlags) -> String {
        let key = keyLabel(forKeyCode: keyCode)
    ...
    private static func modifierPrefix(for modifiers: CGEventFlags) -> String {
        var parts: [String] = []
    ...
    private static func keyLabel(forKeyCode keyCode: UInt16) -> String {
        switch Int(keyCode) {
